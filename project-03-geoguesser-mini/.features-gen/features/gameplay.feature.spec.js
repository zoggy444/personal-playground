...
const bddFileData = [ // bdd-data-start
  ...
  {"pwTestLine":38,"pickleLine":34,"tags":[],"steps":[{"pwStepLine":39,"gherkinStepLine":35,"keywordType":"Context","textWithKeyword":"Given I am in a game","stepMatchArguments":[]},{"pwStepLine":40,"gherkinStepLine":36,"keywordType":"Context","textWithKeyword":"And I have made two incorrect guesses","stepMatchArguments":[]},{"pwStepLine":41,"gherkinStepLine":37,"keywordType":"Action","textWithKeyword":"When I make a third incorrect guess on the map","stepMatchArguments":[]},{"pwStepLine":42,"gherkinStepLine":38,"keywordType":"Outcome","textWithKeyword":"Then I should see a message indicating the guess was incorrect","stepMatchArguments":[]},{"pwStepLine":43,"gherkinStepLine":39,"keywordType":"Outcome","textWithKeyword":"And the region/department I selected should be highlighted red on the map","stepMatchArguments":[]},{"pwStepLine":44,"gherkinStepLine":40,"keywordType":"Outcome","textWithKeyword":"And I should not be able to make another guess","stepMatchArguments":[]},{"pwStepLine":45,"gherkinStepLine":41,"keywordType":"Outcome","textWithKeyword":"And A new round button should be available to start the next round","stepMatchArguments":[]}]},
  {"pwTestLine":48,"pickleLine":43,"tags":[],"steps":[{"pwStepLine":49,"gherkinStepLine":44,"keywordType":"Context","textWithKeyword":"Given The \"new round\" button is available","stepMatchArguments":[{"group":{"start":4,"value":"\"new round\"","children":[{"start":5,"value":"new round","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":50,"gherkinStepLine":45,"keywordType":"Action","textWithKeyword":"When I click on \"New Round\"","stepMatchArguments":[{"group":{"start":11,"value":"\"New Round\"","children":[{"start":12,"value":"New Round","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":51,"gherkinStepLine":46,"keywordType":"Outcome","textWithKeyword":"Then the name of a new region/department to guess should be displayed","stepMatchArguments":[]},{"pwStepLine":52,"gherkinStepLine":47,"keywordType":"Outcome","textWithKeyword":"And the map should reset to its initial state","stepMatchArguments":[]}]},
]; // bdd-data-end