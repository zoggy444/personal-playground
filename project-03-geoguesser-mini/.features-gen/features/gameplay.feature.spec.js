...
test.describe('Gameplay', () => {
  ...
  test('Start a new game', async ({ Given, page, When, Then, And }) => { 
    ...
    await Then('A map of France with regions or department borders should be displayed', null, { page }); 
    await And('regions/departments names should be hidden', null, { page }); 
  ...
  test('Guess incorrectly a location for the third time', async ({ Given, page, And, When, Then }) => { 
    ...
    await And('A new round button should be available to start the next round', null, { page }); 
    await And('the correct region/department should be intermitentently highlighted in green on the map', null, { page }); 
  });
...
const bddFileData = [ // bdd-data-start
  ...
  {"pwTestLine":23,"pickleLine":21,"tags":[],"steps":[{"pwStepLine":24,"gherkinStepLine":22,"keywordType":"Context","textWithKeyword":"Given I am in a game","stepMatchArguments":[]},{"pwStepLine":25,"gherkinStepLine":23,"keywordType":"Action","textWithKeyword":"When I make a correct guess on the map","stepMatchArguments":[]},{"pwStepLine":26,"gherkinStepLine":24,"keywordType":"Outcome","textWithKeyword":"Then I should see a message indicating the guess was correct","stepMatchArguments":[]},{"pwStepLine":27,"gherkinStepLine":25,"keywordType":"Outcome","textWithKeyword":"And the correct region/department should be highlighted green on the map","stepMatchArguments":[]},{"pwStepLine":28,"gherkinStepLine":26,"keywordType":"Outcome","textWithKeyword":"And A new round button should be available to start the next round","stepMatchArguments":[]}]},
  {"pwTestLine":31,"pickleLine":28,"tags":[],"steps":[{"pwStepLine":32,"gherkinStepLine":29,"keywordType":"Context","textWithKeyword":"Given I am in a game","stepMatchArguments":[]},{"pwStepLine":33,"gherkinStepLine":30,"keywordType":"Action","textWithKeyword":"When I make an incorrect guess on the map","stepMatchArguments":[]},{"pwStepLine":34,"gherkinStepLine":31,"keywordType":"Outcome","textWithKeyword":"Then I should see a message indicating the guess was incorrect","stepMatchArguments":[]},{"pwStepLine":35,"gherkinStepLine":32,"keywordType":"Outcome","textWithKeyword":"And the region/department I selected should be highlighted red on the map","stepMatchArguments":[]}]},
  {"pwTestLine":38,"pickleLine":34,"tags":[],"steps":[{"pwStepLine":39,"gherkinStepLine":35,"keywordType":"Context","textWithKeyword":"Given I am in a game","stepMatchArguments":[]},{"pwStepLine":40,"gherkinStepLine":36,"keywordType":"Context","textWithKeyword":"And I have made two incorrect guesses","stepMatchArguments":[]},{"pwStepLine":41,"gherkinStepLine":37,"keywordType":"Action","textWithKeyword":"When I make a third incorrect guess on the map","stepMatchArguments":[]},{"pwStepLine":42,"gherkinStepLine":38,"keywordType":"Outcome","textWithKeyword":"Then I should see a message indicating that I lost the round","stepMatchArguments":[]},{"pwStepLine":43,"gherkinStepLine":39,"keywordType":"Outcome","textWithKeyword":"And the region/department I selected should be highlighted red on the map","stepMatchArguments":[]},{"pwStepLine":44,"gherkinStepLine":40,"keywordType":"Outcome","textWithKeyword":"And I should not be able to make another guess","stepMatchArguments":[]},{"pwStepLine":45,"gherkinStepLine":41,"keywordType":"Outcome","textWithKeyword":"And A new round button should be available to start the next round","stepMatchArguments":[]},{"pwStepLine":46,"gherkinStepLine":42,"keywordType":"Outcome","textWithKeyword":"And the correct region/department should be intermitentently highlighted in green on the map","stepMatchArguments":[]}]},
  {"pwTestLine":49,"pickleLine":44,"tags":[],"steps":[{"pwStepLine":50,"gherkinStepLine":45,"keywordType":"Context","textWithKeyword":"Given I am in a game","stepMatchArguments":[]},{"pwStepLine":51,"gherkinStepLine":46,"keywordType":"Context","textWithKeyword":"And The \"New Round\" button is available","stepMatchArguments":[{"group":{"start":4,"value":"\"New Round\"","children":[{"start":5,"value":"New Round","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":52,"gherkinStepLine":47,"keywordType":"Action","textWithKeyword":"When I click on \"New Round\"","stepMatchArguments":[{"group":{"start":11,"value":"\"New Round\"","children":[{"start":12,"value":"New Round","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":53,"gherkinStepLine":48,"keywordType":"Outcome","textWithKeyword":"Then the name of a region/department to guess should be displayed","stepMatchArguments":[]},{"pwStepLine":54,"gherkinStepLine":49,"keywordType":"Outcome","textWithKeyword":"And the map should reset to its initial state","stepMatchArguments":[]}]},
]; // bdd-data-end